...
def register_dispatch(request):
    ...
    if request.method == 'POST':
        ...
        if serializer.is_valid():
            ...
            dispatch = DispatchDriver.objects.create(
                user=user,
            )
            dispatch.save()
...
class DispatchDriverLogin(APIView):
    authentication_classes = []
    permission_classes = []
...
@permission_classes([])
@authentication_classes([])
def verify_dispatch_email(request):
    payload = {}
    data = {}
    errors = {}
...
@authentication_classes([])
def resend_dispatch_email_verification(request):
    payload = {}
    data = {}
    errors = {}
    email_errors = []
